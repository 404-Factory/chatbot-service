...
@Service
public class RdsRecipeContextResolver implements RecipeContextResolver {

    private final NamedParameterJdbcTemplate jdbcTemplate;

    public RdsRecipeContextResolver(NamedParameterJdbcTemplate jdbcTemplate) {
        this.jdbcTemplate = jdbcTemplate;
    }

    @Override
    public RecipeRecommendationContext resolve(RecipeRecommendRequest request) {
    ...
    private Optional<ProductionContext> findLatestProductionContext(RecipeRecommendRequest request) {
