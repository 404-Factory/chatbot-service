...
@Service
public class BedrockRecipeAgentClient implements RecipeAgentClient {

    private static final Logger log = LoggerFactory.getLogger(BedrockRecipeAgentClient.class);
    ...
    @Override
    public RecipeAgentResponse recommend(RecipeAgentRequest request) {
    ...
    private String buildPrompt(RecipeAgentRequest request) {
        return """
    ...
    private String toJson(RecipeAgentRequest request) {
        try {
    ...
    private RecipeAgentResponse parseResponse(String completion) {
        String json = extractJsonObject(completion);
        try {
            RecipeAgentResponse response = objectMapper.readValue(json, RecipeAgentResponse.class);
